...
/**
 * Pre-configured logger instance for the ADS-B Gateway module
 */
class ADSBGatewayLogger {
  private logger = Logger.getInstance();
  private module = AirStreamModule.ADSB_GATEWAY;
...
export const logger = new ADSBGatewayLogger();
